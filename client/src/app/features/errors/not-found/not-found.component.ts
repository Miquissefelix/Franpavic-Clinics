...
@Component({
  ...
  styles: [`
    ...
    .error-content { text-align:center;max-width:400px;
      .error-code { font-size:120px;font-weight:800;color:var(--color-primary-100);line-height:1; }
      .error-icon { margin-top:-20px;margin-bottom:16px; mat-icon { font-size:64px;width:64px;height:64px;color:var(--color-primary-400); } }
      h1 { font-size:24px;font-weight:700;color:var(--text-primary);margin:0 0 12px; }
